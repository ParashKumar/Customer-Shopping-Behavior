...
-- Compare the average purchase amounts between standard and express shippping
...
-- Compare spend and total revenue between subscribe and non-subscribers 
...
-- Segment customers into new, returning and loyal based on thier total number of previous
